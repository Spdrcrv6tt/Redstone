      ...
      <div className="ambient-aurora-mask absolute inset-x-0 top-0 h-[68vh]">
        ...
        <div
          className={`ambient-orb ambient-orb-2 absolute rounded-full will-change-transform ${
            isDark
              ? "top-[-2%] right-[-2%] w-[min(620px,80vw)] h-[min(260px,30vh)]"
              : "top-[0%] right-[4%] w-[min(560px,74vw)] h-[min(240px,28vh)]"
          }`}
        />
        ...
        <div
          className={`ambient-orb ambient-orb-4 absolute rounded-full will-change-transform ${
            isDark
